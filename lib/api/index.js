 ...
 *
 * @param {integer}  promotorCode
 * @param {integer}  performerCode
 * @param {Function} [done] Optional callback, in case you don't feel like using promises.
 *
 * @returns {Promise}
 */
Api.prototype.addProvisionCode = function addProvisionCode (promotorCode, performerCode, done) {
  var parameters = {
    'action'   : 'relation',
    'type'     : 'add',
    'relation' : 'provision',
    'hoofdcode': promotorCode,
    'subcode'  : performerCode,
  };
